		...
		$(document).ready(function(){
			...
			var jVal = {
				...
				'pname' : function() {
					...
					if(ele.val().length < 3) {
						jVal.errors = true;
							nameInfo.removeClass('correct').addClass('error').html('&larr; service name should be of at least 3 letters').show();
...
<form id=jform method="post" action="http://localhost:8080/Bizzlers/addservice">
	
		<table>
			<tr>
				<td align="right"> Service Name *:</td>
				<td align="left"><input type='text' name='sname' id='sname' /></td>
			</tr>
			<tr><td><br/></td></tr>
			<tr>
