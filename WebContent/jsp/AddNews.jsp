	...
	<div id="page">
		<div id="content">
				...
				<ul class="svertical">
						...
						<li><a href="http://localhost:8080/Bizzlers/jsp/adminprofile.jsp"> Back </a></li>
				</ul>
				</div>
		...
		<h5> 
<%
		String newsbid = request.getParameter("bid");

		if(newsbid.equals("-1"))
			out.print("<form id=jform  method=post action=http://localhost:8080/Bizzlers/AddAdminNews>");
		else
			out.print("<form id=jform  method=post action=http://localhost:8080/Bizzlers/addnews>");
%> 				
		<table>
			<tr>
				<td align="right">News Title *:</td>
				<td align="left"><input type="text" name="nname" id="nname" /></td>
			</tr>
			<tr><td><br/></td></tr>
			<tr>
