	...
	<div id="page">
		<div id="content">
			...
			<input class=inputsubmit type="submit" value="Search" />
			    ...
			    <br/> 
				  <h4> <center> List of Products   </center> </h4>
		<h5>
				
<%
@SuppressWarnings("unchecked")
Vector<ClassResultSet> list =(Vector<ClassResultSet>)request.getAttribute("productNames");

if (list.size() <= 0 ){
	out.print("<h4> No Products added </h4>");
	out.print("<h4> <a href=http://localhost:8080/Bizzlers/jsp/AddProduct.jsp > Add Product </a> </h4>");
}
else {
	
out.print("<h4> Total  " + list.size() +"  Products </h4>");

for(int i = 0 ; i < list.size() ; i ++ ){
	out.print("<br/> <h4> <a href=http://localhost:8080/Bizzlers/DisplayDetails?id="+list.elementAt(i).getFieldOne()+"&dataType=1> " + list.elementAt(i).getFieldTwo()+ "</a><br/>"+ list.elementAt(i).getFieldThree() + " &nbsp; &nbsp; &nbsp; <a href=http://localhost:8080/Bizzlers/DeletePST?id="+ 
			list.elementAt(i).getFieldOne() +"&dataType=1&cat="+ list.elementAt(i).getFieldFive() +"> Delete </a> </h4> " ) ;	
}
}
%>
