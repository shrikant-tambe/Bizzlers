		...
		$(document).ready(function(){
			...
			var jVal = {
				...
				'pname' : function() {
					...
					if(ele.val().length < 3) {
						jVal.errors = true;
							nameInfo.removeClass('correct').addClass('error').html('&larr; tag name should be of at least 3 letters').show();
...
<div class="bottombar"></div>
	...
	<div id="page">
		<div id="content">
			...
			Describe your business more precisely by adding Tags of your business. <br/>
		<br/>			
<form id=jform method="post" action="http://localhost:8080/Bizzlers/addtag">
		
		<table> 	
			<tr>
				<td align="right"> Tag Name:</td>
				<td align="left"><input type='text' name='tname' id='tname' /></td>
			</tr>
			<tr><td><br/></td></tr>
			<tr>
